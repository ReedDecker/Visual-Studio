...
function newColor() {
    document.getElementById("goodbye_earthlings").style.color = "darkgoldenrod";
}

function oldColor() {
    document.getElementById("goodbye_earthlings").style.color = "darkolivegreen";
}
